...
div.stButton > button {
    background: linear-gradient(180deg, #9b3fe0 0%, #6A0DAD 55%, #56099a 100%) !important;
    color: white !important;
    border: none !important;
    border-bottom: 3px solid #3d0770 !important;
    font-weight: bold !important;
...
div.stButton > button:hover {
    background: linear-gradient(180deg, #ab52e8 0%, #7c1fc4 55%, #62089f 100%) !important;
...
.model-btn-marker.active + div[data-testid="stButton"] button {
    background: linear-gradient(180deg, #c17bff 0%, #8b1fe0 55%, #6A0DAD 100%) !important;
    border-bottom: 3px solid #2e0658 !important;
    box-shadow: 0 5px 0 #2e0658, 0 0 0 3px rgba(180,92,255,0.45), 0 12px 26px rgba(106,13,173,0.5) !important;
    transform: translateY(-3px);
    opacity: 1;
}
...
.hero-model-card {
    background: radial-gradient(circle at 85% 0%, rgba(180,92,255,0.20), transparent 45%),
                linear-gradient(135deg, #26004a 0%, #3a0a63 55%, #1c0038 100%);
    border-radius: 20px;
    padding: 26px 30px;
    margin-bottom: 22px;
    box-shadow: 0 14px 34px rgba(72,0,120,0.28);
    position: relative;
    overflow: hidden;
}
.hero-model-card::after {
    ...
    background: linear-gradient(90deg, #6A0DAD, #d8a8ff, #6A0DAD);
    background-size: 200% 100%;
    animation: gradientMove 4s linear infinite;
}
.hero-model-name { color: #fff; font-size: 24px; font-weight: 800; margin: 0; letter-spacing: -0.3px; }
.hero-model-sub { color: rgba(255,255,255,0.6); font-size: 13px; letter-spacing: 0.5px; margin-top: 2px; }
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:18px;">
            ...
            <div style="display:flex; gap:28px; flex-wrap:wrap;">
                <div style="text-align:center;">
                    <div style="color:#fff; font-size:26px; font-weight:800;">{model_accuracy:.1%}</div>
                    <div style="color:rgba(255,255,255,0.55); font-size:11px; letter-spacing:0.5px;">ACCURACY</div>
                </div>
                <div style="text-align:center;">
                    <div style="color:#fff; font-size:26px; font-weight:800;">{sel_extra['Precision']:.1%}</div>
                    <div style="color:rgba(255,255,255,0.55); font-size:11px; letter-spacing:0.5px;">PRECISION</div>
                </div>
                <div style="text-align:center;">
                    <div style="color:#fff; font-size:26px; font-weight:800;">{sel_extra['Recall']:.1%}</div>
                    <div style="color:rgba(255,255,255,0.55); font-size:11px; letter-spacing:0.5px;">RECALL</div>
                </div>
                <div style="text-align:center;">
                    <div style="color:#fff; font-size:26px; font-weight:800;">{sel_extra['AUC']:.1%}</div>
                    <div style="color:rgba(255,255,255,0.55); font-size:11px; letter-spacing:0.5px;">AUC</div>
                </div>
            </div>
        </div>
    </div>
